using BasicFrame.Animations.Base;
using BasicFrame.Helpers;
using System;
using System.Threading.Tasks;
using Xamarin.Forms;

namespace BasicFrame.Animations
{
    ...
    public class FadeInAnimation : AnimationBase
    {
        ...
        internal Animation FadeIn()
        {
            ...
            animation.WithConcurrent(
              ...
              Target.TranslationY + ((Direction == FadeDirection.Up) ? 200 : -200), Target.TranslationY,
